...
<head>
    ...
    <title>Scripta - Wujudkan Karya Ilmiah Berkualitas</title>
...
<body>
    ...
    <header id="mainHeader">
        <div class="container header-container">
            <div class="logo">
                <img src="landing/assets/images/scripta-99x99.png" alt="Scripta Logo">
                <span class="logo-text">SCRIPTAPUBLISHING</span>
            </div>
    ...
    <section class="hero">
        ...
        <div class="container hero-content">
            ...
            <div class="cta-buttons">
                <a href="https://wa.me/6281234567890?text=Halo%20Scripta%20Publishing,%20saya%20ingin%20bertanya%20tentang..." class="whatsapp-btn" target="_blank">
    ...
    <section class="journal-types-section">
        <div class="container">
            ...
            <div class="journal-cards-container">
                <div class="journal-card">
                    ...
                    <a href="#" class="journal-learn-more">Pelajari Lebih Lanjut →</a>
                </div>
    ...
    <footer class="site-footer">
        ...
        <div class="footer-bottom">
            <div class="container">
                <p>&copy; 2023 Scripta Publishing. Hak Cipta Dilindungi.</p>
